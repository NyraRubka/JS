...
let item_5 = item_3 //Присвоить переменной item_5 переменную item_3
...
console.log("item_7 == " + typeof(item_7), "item_7_type == " + item_7_type) //Вывести в консоль тип данных item_7 в виде ——  “item_7 == ”  item_7,  “item_7_type == ”  item_7_type ——

let age_1 = 10 //Создать переменную “age_1” и присвоить ей значение 10
let age_2 = 18 //Создать переменную “age_1” и присвоить ей значение 18
let age_3 = 60 //Создать переменную “age_1” и присвоить ей значение 60
